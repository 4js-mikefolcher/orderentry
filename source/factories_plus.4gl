...
FUNCTION zoomFactory()
   ...
   OPEN WINDOW factoryWindow WITH FORM "factories_plus"
...
FUNCTION loadFactories(cbx ui.ComboBox)
	DEFINE r_factory RECORD LIKE factory.*
	...
	FOREACH cursFactories INTO r_factory.*
		...
		CALL cbx.addItem(r_factory.fac_code, r_factory.fac_name)

	END FOREACH #cursFactories

END FUNCTION #loadFactories
