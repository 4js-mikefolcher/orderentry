...
FUNCTION zoomStock()
   ...
   OPEN WINDOW stockWindow WITH FORM "stockitems_plus"
...
FUNCTION loadStocks(cbx ui.ComboBox)
	DEFINE r_stock RECORD LIKE stock.*
	...
	FOREACH cursStocks INTO r_stock.*
		...
		CALL cbx.addItem(r_stock.stock_num, r_stock.description)

	END FOREACH #cursStocks
