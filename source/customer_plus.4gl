...
FUNCTION zoomCustomer()
   ...
   OPEN WINDOW customerWindow WITH FORM "customer_plus"
...
FUNCTION loadCustomers(cbx ui.ComboBox)
	DEFINE r_customer RECORD LIKE customer.*
	...
	FOREACH cursCustomers INTO r_customer.*
		...
		CALL cbx.addItem(r_customer.store_num, r_customer.store_name)

	END FOREACH #cursCustomers

END FUNCTION #loadCustomers
